 ...
 */
final class Version20241122165022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, event_name VARCHAR(50) NOT NULL, event_date DATE NOT NULL, event_place VARCHAR(50) NOT NULL, event_desc VARCHAR(255) NOT NULL, type_evenemnt VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, title VARCHAR(50) NOT NULL, projetdesc VARCHAR(255) DEFAULT NULL, INDEX IDX_50159CA9FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, quiz_title VARCHAR(50) NOT NULL, quiz_type VARCHAR(50) NOT NULL, question JSON NOT NULL COMMENT \'(DC2Type:json)\', resultat INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
